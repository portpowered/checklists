...
- See [examples/website-checklist-review-example.md](examples/website-checklist-review-example.md) for a completed sample review record that demonstrates the expected output shape and decision model.
